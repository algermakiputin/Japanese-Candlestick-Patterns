...
export default function ThreeStarInTheSouth() {
    ...
    return (
        <View>
            ...
            <ul>
                <li>The market has to be in a downtrend</li>
                <li>The first candlestick is black, with a long real body, long lower shadow, and it lacks an upper shadow</li>
                <li>The second candlestick is black with a shorter real body and a low that’s higher than that of the first low candle</li>
                <li>The third candlestick is black with a short real body, without shadows, and a close that is within the second candle’s high-low range</li>
            </ul>
