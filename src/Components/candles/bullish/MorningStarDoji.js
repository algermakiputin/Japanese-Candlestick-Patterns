...
export default function MorningStarDoji() {
    ...
    return (
        <View>
            ...
            <ul>
                <li>The first day of this pattern is a long bearish candlestick</li>
                <li>The second day is a doji candlestick signifying market indecision</li>
                <li>The third day is a large bullish candle, above the second day candle and closes at the midpoint of the first candlestick</li>
            </ul>
