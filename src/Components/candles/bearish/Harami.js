...
export default function Harami() {
    ...
    return (
        <View>
            ...
            <ul>
                <li>The opening price of the second candle is lower than the closing price of the first bullish candle, so the day starts with a gap down and sellers are gaining control.</li>
                <li>The rest of the trading session, buyers and sellers more or less keep each other in balance. A slightly negative closing price is a sign that sellers, after the initial gap down, have maintained control. However, there was not yet enough momentum to lower the price below the opening price of the previous day. As a result, we see an 'inside candle.</li>
            </ul>
