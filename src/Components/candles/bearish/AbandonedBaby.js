...
export default function AbandonedBaby() {
    ...
    return (
        <View>
            ...
            <ul>
                <li>The first candle is a bullish candle.</li>
                <li>The second candle is a doji candle.</li>
                <li>The third candle gaps down below the second candle shadow, and closes within the midpoint of the first candlestick.</li>
            </ul>
