...
export default function AbandonedBaby() {
    ...
    return (
        <View>
            ...
            <ul>
                <li>The first candle is a long bullish candle.</li>
                <li>The second candle is a Doji candle.</li>
                <li>The third candle opens below the second candle’s body and then close below the midpoint of the first candlestick body. </li>
            </ul>
