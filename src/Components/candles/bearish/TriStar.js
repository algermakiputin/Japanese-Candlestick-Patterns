...
export default function TriStar() {
    ...
    return (
        <View>
            ...
            <ul>
                <li>The tri-star candlestick pattern is a 3-bar trend reversal pattern. </li>
                <li>There must be a clear and defined trend in the market.</li>
                <li>Three consecutive Doji candles must appear.</li>
                <li>The second Doji candle must create a gap below the first and third Doji candles creating a shape that resembles the letter “V” (or the opposite for the bearish variation).</li>
            </ul>
